...
#############################################################
#            Manage Credentials in The Platform             #
#############################################################
# This is an example of adding roles to the platform over
# the API. To use, set the Platform API and Secret Key in
# config.py
#
# Then add the roles to roles.csv in the format:
# role,alias
# Where role is the full arn of the role,
# e.g. arn:aws:iam::0001:role/CadoResponseRole
# And the Alias is the name you want to save the credentials
# under to be viewable in the UI, e.g. My Role
#############################################################
...
if __name__ == "__main__":
    ...
    post_role_batch(config.API_URL, config.API_KEY, "roles.csv")
